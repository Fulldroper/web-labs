...
function authorSet(){
	document.getElementById("author").innerHTML="<div align=left style=padding:5;padding-left:5; ><p><h3 style=color:#839496; >Лабораторна робота.</h3></p><p style=color:#839496; >Курс: Веб програмування.</p></div>";
}
